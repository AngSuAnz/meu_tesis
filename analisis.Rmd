...
#CONSTRUYO ISOCRONAS DE 20M
#lista_isocronas20 <- lapply(puntos_aleatorios_bm$geometry, function(point) {
#  osrmIsochrone(loc = st_coordinates(point),
#                breaks = seq(from = 0, to = 20, by = 20),
#                res = 40,
#                osrm.profile = "foot")
#})

#Combino las isocronas
#isocronas_bind20 <- do.call(rbind, lista_isocronas20)

#st_write(isocronas_bind20, "data/isocronas20.geojson")

isocronas20 = st_read("data/isocronas20.geojson")%>% 
                    st_transform(4326) %>% 
...
leaflet(st_zm(ciudad)) %>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("Puntos Aleatorios Barrio Mugica", "Isocronas Barrio Mugica","CABA","Barrio Mugica","Sectores Próximos" ))%>% 
